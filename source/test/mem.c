...
static void mem_is_filled_test(void)
{
	...
	CU_ASSERT(mem_is_filled(buf, 0xAA, sizeof(buf)));
	...
	memset(buf, 0xAA, sizeof(buf));
	CU_ASSERT(mem_is_filled(buf + 1, 0xAA, sizeof(buf) - 1));

	memset(buf, 0xAA, sizeof(buf));
	CU_ASSERT(!mem_is_filled(buf + 1, 0x55, sizeof(buf) - 1));

	memset(buf, 0xAA, sizeof(buf));
	CU_ASSERT(mem_is_filled(buf, 0xAA, sizeof(buf) - 3));
